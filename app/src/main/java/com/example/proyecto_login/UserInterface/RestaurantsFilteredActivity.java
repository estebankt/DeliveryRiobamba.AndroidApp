...
public class RestaurantsFilteredActivity extends OptionMenuActivity {
    ...
    private void fetchJSON(){
        ...
        progressDoalog = new ProgressDialog(RestaurantsFilteredActivity.this);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onFailure(Call<String> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(RestaurantsFilteredActivity.this, "Algo salio mal, intentelo mas tarde", Toast.LENGTH_SHORT).show();
        ...
        try {
            //getting the whole json object from the response
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    if (dataobj.getString("type").equals(TypeName)) {
